...
const (
	Products_GetProduct_FullMethodName  = "/dapr.examples.golang.products.v1.Products/GetProduct"
	Products_SaveProduct_FullMethodName = "/dapr.examples.golang.products.v1.Products/SaveProduct"
)
...
func (c *productsClient) SaveProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Products_SaveProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Products_SaveProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Products_SaveProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
